...
def get_financials_for_all_codes(db_path):
    try:
        ...
        for symbol in symbols:
            ...
            to_sqlite(df, db_path, table_name='financial_data', symbol='', if_exists='append')
...
def get_stock_data_for_selected_codes(db_path):
    try:
        ...
        for symbol in symbols:
            ...
            df3 = get_all_financial_data(symbol)
            to_sqlite(df3, db_path, table_name='all_financial_data', symbol='', if_exists='append')
